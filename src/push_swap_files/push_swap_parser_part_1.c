...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   push_swap_parser_part_1.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: anasinda <anasinda@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/22 18:22:07 by anasinda          #+#    #+#             */
/*   Updated: 2026/01/04 18:03:04 by anasinda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_arg_parser(char	**args, t_arg	**stack_a)
{
	...
	i = 0;
	while (args[++i])
		if (ft_double_check_signs((splited_args = ft_split(args[i], " \t"))) == -1)
			return (-1);

	return ft_arg_parser_part_two(args, splited_args, stack_a);
}
